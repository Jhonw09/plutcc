    ...
    <header className={`${styles.header} ${scrolled ? styles.scrolled : ''}`}>
      <div className={styles.inner}>
        ...
        <div className={styles.actions}>
          <button onClick={() => navigate('/login')}   className={styles.loginBtn}>Entrar</button>
          <button onClick={() => navigate('/cadastro')} className={styles.registerBtn}>Cadastre-se grátis</button>
        </div>
      ...
      {open && (
        <div className={styles.mobileMenu}>
          ...
          <button onClick={() => { navigate('/login');   setOpen(false) }} className={styles.mobileLink}>Entrar</button>
          <button onClick={() => { navigate('/cadastro'); setOpen(false) }} className={`${styles.mobileLink} ${styles.mobileCta}`}>Cadastre-se grátis</button>
        </div>
      )}
    </header>
  )
