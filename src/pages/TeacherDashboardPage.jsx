...
function buildStats(classes) {
  ...
  return [
    { id: 'classes',  icon: 'school',  label: 'Turmas ativas',   value: classes.length,  delta: null },
    { id: 'students', icon: 'users',   label: 'Total de alunos', value: 'N/A',            delta: null },
    { id: 'public',   icon: 'globe',   label: 'Turmas públicas', value: publicCount,      delta: null },
    { id: 'private',  icon: 'lock',    label: 'Turmas privadas', value: classes.length - publicCount, delta: null },
  ]
}
